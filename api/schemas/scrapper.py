...
class ProcessoResumoTJSP(BaseModel):
    numeroProcesso: str
    processoCodigo: Optional[str] = None
    foroId: Optional[str] = None
    linkPublico: str
    tipoParticipacao: Optional[str] = None
...
class ProcessoTJSP(BaseModel):
    ...
    advogadoConsumidor: Optional[str] = None
    dataAudiencia: Optional[str] = None
    situacaoProcessual: Optional[str] = None
...
class TJSPProcessoQuery(BaseModel):
    """Input payload accepted by the TJSP scraping tool."""
